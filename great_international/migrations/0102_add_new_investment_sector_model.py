    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_text', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_en_gb', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_de', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_ja', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_zh_hans', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_fr', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_es', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_pt', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
                ('intro_text_ar', wagtailmarkdown.fields.MarkdownField(blank=True, null=True)),
