    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_one_intro', wagtailmarkdown.fields.MarkdownField(validators=[core.validators.slug_hyperlinks])),
                ('selling_point_one_heading', models.CharField(max_length=255)),
                ('selling_point_one_content', wagtailmarkdown.fields.MarkdownField(validators=[core.validators.slug_hyperlinks])),
                ('selling_point_two_heading', models.CharField(blank=True, max_length=255, null=True)),
                ('selling_point_two_content', wagtailmarkdown.fields.MarkdownField(blank=True, null=True, validators=[core.validators.slug_hyperlinks])),
                ('selling_point_three_heading', models.CharField(blank=True, max_length=255, null=True)),
                ('selling_point_three_content', wagtailmarkdown.fields.MarkdownField(blank=True, null=True, validators=[core.validators.slug_hyperlinks])),
                ...
                ('section_two_intro', wagtailmarkdown.fields.MarkdownField(validators=[core.validators.slug_hyperlinks])),
                ...
                ('related_content_intro', wagtailmarkdown.fields.MarkdownField(validators=[core.validators.slug_hyperlinks])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list_teaser', wagtailmarkdown.fields.MarkdownField(blank=True, null=True, validators=[core.validators.slug_hyperlinks])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_one_body', wagtailmarkdown.fields.MarkdownField(null=True, validators=[core.validators.slug_hyperlinks], verbose_name='Bullets markdown')),
