...
class InvestHighPotentialOpportunityFormPageTranslationOptions(
    BaseTranslationOptions
):
    fields = []
...
class InvestHighPotentialOpportunityDetailPageTranslationOptions(
    BaseTranslationOptions
):
    fields = []
...
class InvestHighPotentialOpportunityFormSuccessPageTranslationOptions(
    BaseTranslationOptions
):
    fields = []
