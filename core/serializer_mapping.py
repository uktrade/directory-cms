...
MODELS_SERIALIZERS_MAPPING = {
    ...
    great_international.models.CapitalInvestRegionalSectorOpportunityPage: great_international.serializers.CapitalInvestRegionalSectorOpportunityPageSerializer,  # NOQA
