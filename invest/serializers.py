...
class InvestHomePageSerializer(BasePageSerializer):
    ...
    hero_call_to_action_url = serializers.URLField(max_length=255)
    hero_image = wagtail_fields.ImageRenditionField('original')
    ...
    capital_invest_section_cta_url = serializers.URLField(max_length=255)
    ...
    eu_exit_section_call_to_action_url = serializers.URLField(max_length=255)
    ...
    sector_button_url = serializers.URLField(max_length=255)
    ...
    setup_guide_call_to_action_url = serializers.URLField(max_length=255)
    ...
    contact_section_call_to_action_url = serializers.URLField(max_length=255)
